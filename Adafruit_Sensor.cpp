...
void Adafruit_Sensor::printSensorDetails(void) {
  ...
  getSensor(&sensor);
    ...
    std::cout << "Type:       " << sensor.name;
    switch ((sensors_type_t)sensor.type) {
    case SENSOR_TYPE_ACCELEROMETER:
      std::cout << "Acceleration (m/s2)" << std::endl;
      break;
    case SENSOR_TYPE_MAGNETIC_FIELD:
      std::cout << "Magnetic (uT)" << std::endl;
      break;
    case SENSOR_TYPE_ORIENTATION:
      std::cout << "Orientation (degrees)" << std::endl;
      break;
    case SENSOR_TYPE_GYROSCOPE:
      std::cout << "Gyroscopic (rad/s)" << std::endl;
      break;
    case SENSOR_TYPE_GRAVITY:
      std::cout << "Gravity (m/s2)" << std::endl;
      break;
    case SENSOR_TYPE_LINEAR_ACCELERATION:
    ...
    std::cout << "Driver Ver:   ";
    std::cout << sensor.version << std::endl;
    std::cout << "Unique ID:    ";
    std::cout << sensor.sensor_id << std::endl;
    std::cout << "Min Value:    ";
    std::cout << sensor.min_value << std::endl;
    std::cout << "Max Value:    ";
    std::cout << sensor.max_value << std::endl;
    std::cout << "Resolution:   ";
    std::cout << sensor.resolution << std::endl;
    std::cout << "------------------------------------" << std::endl;
